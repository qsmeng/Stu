...
public class JsoupForB {
	public static void main(String[] args) {

		JsoupForB forB = new JsoupForB();
		String[][] str = forB.parseHTML("金庸");
	...
	public String getHTML(String key) throws IOException {
		...
		String path = "https://www.baidu.com/s?tn=baidulocal&word=" + URLEncoder.encode(key, "gb2312") + "&rn=100";
	...
	public String[][] parseHTML(String key) {
		...
		String[][] pageContent_list = new String[10][3];
		if (page != null) {
